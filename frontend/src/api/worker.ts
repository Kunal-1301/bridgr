...
export const getWorkerStats = () => getWorkerDashboard()
...
export const getPayments = async () => toWorkerPayments(await getOrMock('/worker/payments', mockPayments))
...
export const updateWorkerProfile = async (workerId: string, payload: Partial<WorkerProfile>) => {
  void workerId
  try {
...
export const getWorkerPayments = (workerId?: string) => {
  void workerId
  return getPayments()
}
